        ...
        <BootstrapLayout>
            ...
            <div className="container my-4">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input className="form-control" type="text" name="image" value={formData.image} onChange={handleChange} placeholder="Image URL" />
                    {errors.image && (
                        <div>
                    ...
                    <div className="mt-4">
                        <a className="btn btn-secondary me-2" href="/product-manager">
                            back
                        </a>
